subroutine advance_horizontal(iBlock)
  ...
  !! Define intermediate variable, yuhong, 01/10/2025
  real :: NewPresGrad_CD(nLons,nLats,3)
  real :: NewCoriolis_CD(nLons,nLats,3)
  ...
  do iAlt=1,nAlts
     ...
     !! Similarly, pass NewPresGrad_CD 2 PresGrad, yuhong, 01/10/2025
     PresGrad(1:nLons,1:nLats,iAlt,:)              = NewPresGrad_CD
     CoriolisF4(1:nLons,1:nLats,iAlt,:)            = NewCoriolis_CD
...
!          endif
          ...
          ! ***************************************************************
          ! so (above L2) is pressure grad force, in momentum equation is:
          ! Gradl**Temp_C + GradL**Rho_C * Temp_C/Rho_C, yuhong, 01/08/2025
          ! ***************************************************************

          ! separate Pressure Gradient Force from Momentum Equation, yuhong, 01/08/2025
          NewPresGrad_CD(iLon,iLat,iEast_) = GradLonTemp_C(iLon,iLat) + GradLonRho_C(iLon,iLat)*Temp_C(iLon,iLat)/Rho_C(iLon,iLat)
          ...
          ! separate Pressure Gradient Force from Momentum Equation, yuhong, 01/08/2025
          NewPresGrad_CD(iLon,iLat,iNorth_) = GradLatTemp_C(iLon,iLat) + GradLatRho_C(iLon,iLat)*Temp_C(iLon,iLat)/Rho_C(iLon,iLat)
...
!          endif
          ...
          ! separate Pressure Gradient Force from Momentum Equation, yuhong, 01/08/2025 
          NewPresGrad_CD(iLon,iLat,iUp_) = 0.0
          ...
          if (UseCoriolis) then
             ...
             NewCoriolis_CD(iLon,iLat,iEast_) = CoriolisSin * Vel_CD(iLon,iLat,iNorth_) - CoriolisCos * Vel_CD(iLon,iLat,iUp_) ! yuhong, 11/25/2024
             ...
             NewCoriolis_CD(iLon,iLat,iNorth_) = CoriolisSin * Vel_CD(iLon,iLat,iEast_) ! yuhong, 11/25/2024
